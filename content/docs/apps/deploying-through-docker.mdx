...
Aquanode allows you to deploy **custom applications** using Docker images hosted in any container registry (Docker Hub, GitHub Container Registry, private registries, etc.). This provides maximum flexibility for running your own APIs, ML workloads, or microservices directly on Aquanode’s GPU and CPU infrastructure.  

You can access this here: [Docker Services Console](https://console.aquanode.io/workloads/services/docker)

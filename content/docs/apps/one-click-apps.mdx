...
- **Databases & Caching**: Redis, PostgreSQL, MongoDB, Elasticsearch
- **AI & Machine Learning**: Ollama, Stable Diffusion, ComfyUI
...
Aquanode provides optimized default configurations for each application, but all settings can be customized based on your requirements.

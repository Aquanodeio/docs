...
- [Hot Aisle](https://hotaisle.xyz/) – Dell + AMD AI developer cloud
- [Akash Network](https://akash.network/) – Decentralized cloud marketplace  
- [Cudo Compute](https://compute.cudo.org/) - Norway based GPU Provider
- [Hyperstack](https://www.hyperstack.cloud/) - Canada Based GPU Provider
- [Vast.ai](https://vast.ai/) - Community Marketplace
- [Massed Compute](https://massedcompute.com/) - US based GPU Provider, Small enterprise scale
- [Vultr](https://www.vultr.com/) - Virtualized Low VRAM GPUs
...
See [GPU Types](/docs/cloud-features/gpu-types) and [Pricing](/docs/cloud-features/pricing) for details.
...
Launch a **GPU VM template** (Ubuntu, Debian, PyTorch, TensorFlow) directly from the [VM Templates](../virtual-machines/vm-templates.mdx) page — your environment will be ready in seconds.
...
Reach out to us at [hi@aquanode.io](mailto:hi@aquanode.io) or join our community on Discord (coming soon).

...
Navigate to [https://console.aquanode.io/workloads/model-pipeline/serverless-comfyui](https://console.aquanode.io/workloads/model-pipeline/serverless-comfyui).

---
title: "Running a VM"
description: "Deploy and manage GPU-powered virtual machines on Aquanode with complete control over your computing environment."
---
...
- You want managed AI model deployment → Use [Model Pipeline](/docs/models)
- You need simple app hosting → Use [App Deployment](/docs/apps)
...
- **Documentation**: Browse our [VM guides and tutorials](/docs/vm)
- **Support**: Contact our team at [support@aquanode.io](mailto:support@aquanode.io)

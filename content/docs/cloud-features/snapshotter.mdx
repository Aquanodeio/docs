...
Before using snapshotter, you need to configure your storage credentials:
...
## Enable snapshotter on deployment
...
Snapshotter itself is free. You only pay for:
...
*Snapshotter ensures your important data is always protected and easily recoverable across deployments.*
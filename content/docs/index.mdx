...
5. Save your data with automated or manual backups. 
6. Migrate workloads across any GPU.
7. Monitor your VM's performance and usage in real-time.
...
<Cards>
  ...
  <Card 
    ...
    description="Save your VM data and migrate workloads across GPUs"
  />
  {/* <Card 
